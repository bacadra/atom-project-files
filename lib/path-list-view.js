  ...
  update() {
    if (this.S.pathManager.loadQ) {
      ...
      this.S.pathManager.cache(() => {
        ...
        infoMessage = ['Press ', <span class='keystroke'>Enter</span>, ', ', <span class='keystroke'>Alt|Ctrl-Enter</span>, ', ', <span class='keystroke'>Alt-Left|Right|Up|Down</span>, ', ', <span class='keystroke'>Alt-C|V Alt-P|A|R|N</span>, ' or ', <span class='keystroke'>Alt-0|/|\|Q|S</span>]
