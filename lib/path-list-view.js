  ...
  update() {
    if (!this.S.pathManager.items) {
      ...
      this.S.pathManager.cache(() => {
        ...
        this.selectListView.update({items:this.S.pathManager.items, loadingMessage:null, infoMessage: 'Press [ |Alt|Ctrl]-Enter, Alt+[Left|Right|Up|Down], Ctrl-[C|V] Ctrl-[P|A|R|N] or Alt-[0|/|\\|Q]'})
      })
