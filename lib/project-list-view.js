...
export default class ProjectListView {
  ...
  cache() {
    ...
    Promise.all(promises).then(() => {
      infoMessage = ['Press ', <span class='keystroke'>Enter</span>, ', ', <span class='keystroke'>Alt-Enter</span>, ', ', <span class='keystroke'>Shift-Enter</span>, ' or ', <span class='keystroke'>Alt-V</span>]
